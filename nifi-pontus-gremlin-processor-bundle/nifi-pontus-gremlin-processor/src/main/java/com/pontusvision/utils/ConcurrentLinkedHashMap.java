...
{ // NOPMD
  ...
  public void removeHandler(Entry<K, V> eldest)
  {
  ...
  private class LruCache<A, B> extends LinkedHashMap<A, B>
  {
     ...
     */
    @SuppressWarnings("unchecked") @Override protected boolean removeEldestEntry(final Entry<A, B> eldest)
    {
      boolean removeIt = super.size() > maxEntries;
      if (removeIt)
      {
        removeHandler((Entry<K, V>) eldest);
      }
      return removeIt;
    }
  }
