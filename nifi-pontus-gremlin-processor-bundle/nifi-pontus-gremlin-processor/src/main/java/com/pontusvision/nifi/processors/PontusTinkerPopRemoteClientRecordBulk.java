...
//@SideEffectFree
@Tags({ "GDPR", "record", "bulkload", "Write", "schema", "tinkerpop", "gremlin", "json", "csv", "avro", "log", "logs",
    "freeform",
...
public class PontusTinkerPopRemoteClientRecordBulk extends PontusTinkerPopRemoteClient
{

  static final PropertyDescriptor RECORD_READER = new PropertyDescriptor
      .Builder()
      .name("record-reader")
